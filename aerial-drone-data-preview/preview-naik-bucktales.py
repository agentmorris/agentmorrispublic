#
# Code to render sample images and annotations in the BuckTales dataset:
#
# https://edmond.mpg.de/dataset.xhtml?persistentId=doi:10.17617/3.JCZ9WK
#
# Annotations are boxes in COCO .json files.
#
# Annotations are also available as YOLO .txt files; this script uses the COCO version.
#
...
base_folder = 'i:/data/drone-data/naik-bucktales/Detection_Dataset/coco_format_v1'
...
output_file_annotated = r'g:\temp\bucktales_annotated.jpg'
output_file_unannotated = r'g:\temp\bucktales_unannotated.jpg'
...
for split_name in annotation_files:
    ...
    image_folder = os.path.join(base_folder,split_name + '_images')
...
category_names_to_ignore = ['shadow']
category_ids_to_ignore = []
for s in category_names_to_ignore:
    category_ids_to_ignore.append(category_name_to_id[s])
